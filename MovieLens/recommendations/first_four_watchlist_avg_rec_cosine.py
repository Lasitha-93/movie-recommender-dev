...
def pearson_correlation_watchlist(person1_id, person2_id):
    ...
    if len(user1_rated_details_by_id) > 4:
        user1_rated_details_by_id = user1_rated_details_by_id.head(4)
    if len(user2_rated_details_by_id) > 4:
        user2_rated_details_by_id = user2_rated_details_by_id.head(4)
...
def create_watchlist_basic_sim_matrix():
    ...
    np.savetxt("first_four_watchlist_basic_sim_matrix.csv", a, delimiter=",")
...
def make_recommendations(user_id):
    ...
    recommendation_list = {}
    watchlist_basic_sim_matrix = np.genfromtxt('first_four_watchlist_basic_sim_matrix.csv', delimiter=',')
...
def get_watch_list_basic_rec():
    ...
    with open('first_four_watch_list_based_avg_rec.json', 'w') as file:
