...
def create_user_features_based_cosine_sim_matrix():
    ...
    np.savetxt("first_five_user_features_based_cosine_sim_matrix.csv", a, delimiter=",")
...
def make_recommendations(user_id):
    ...
    user_features_based_sim_matrix = np.genfromtxt('first_five_user_features_based_cosine_sim_matrix.csv', delimiter=',')
