...
def create_watchlist_basic_sim_matrix():
    ...
    np.savetxt("watchlist_basic_cosine_sim_matrix.csv", a, delimiter=",")
...
def make_recommendations(user_id):
    ...
    recommendation_list = {}
    watchlist_basic_sim_matrix = np.genfromtxt('watchlist_basic_cosine_sim_matrix.csv', delimiter=',')
...
def get_watch_list_basic_rec():
    ...
    with open('watch_list_based_avg_rec_cosine.json', 'w') as file:
