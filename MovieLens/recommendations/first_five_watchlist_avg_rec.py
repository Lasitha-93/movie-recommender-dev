...
def create_watchlist_basic_sim_matrix():
    ...
    np.savetxt("first_five_watchlist_basic_sim_matrix.csv", a, delimiter=",")
...
def make_recommendations(user_id):
    ...
    recommendation_list = {}
    watchlist_basic_sim_matrix = np.genfromtxt('first_five_watchlist_basic_sim_matrix.csv', delimiter=',')
...
def get_watch_list_basic_rec():
    ...
    with open('first_five_watch_list_based_avg_rec.json', 'w') as file:
