from test_algorithms.recommendation_data import dataset
...
def similarity_score(person1, person2):
    # Returns ratio Euclidean distance score between person1 and person2
...
print(similarity_score('Lisa Rose', 'Gene Seymour'))
print(pearson_correlation('Lisa Rose', 'Toby'))
...
# print(most_similar_users('Lisa Rose', 2))
...
print(user_recommendations('Lisa Rose'))
